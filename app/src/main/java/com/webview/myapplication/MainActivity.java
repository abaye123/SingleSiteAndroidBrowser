...
public class MainActivity extends Activity {
    ...
    private static final float SWIPE_THRESHOLD = 0.17f; // One-third of the screen height
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        // Check if the swipe started in the top third of the screen
                        boolean isTopThird = startY < (mWebView.getHeight() / 3);

                        // Check if the swipe length is at least one-third of the screen height
                        boolean isLongEnough = Math.abs(deltaY) > (mWebView.getHeight() * SWIPE_THRESHOLD);

                        if (isTopThird && isLongEnough && deltaY > 0) {
                            // Swipe down in the top third, long enough
        ...
        mWebView.setDownloadListener((url, userAgent, contentDisposition, mimeType, contentLength) -> {
            ...
            dm.enqueue(request);
            Toast.makeText(getApplicationContext(), getString(R.string.download_starting), Toast.LENGTH_LONG).show();
        });
    ...
    private class HelloWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (isAllowed) {
                ...
                Toast.makeText(getApplicationContext(), getString(R.string.blocked_is_address) + " (" + host + ")", Toast.LENGTH_LONG).show();
                return true;
            }
        }
        ...
        public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
            ...
            if (NO_SSL && (Objects.equals(issuerName, "NetFree") || Objects.equals(issuerName, "Netspark"))) {
                ...
                if (Objects.equals(issuerName, "NetFree")) {
                    Toast.makeText(getApplicationContext(), getString(R.string.not_ssl_by_netfree), Toast.LENGTH_LONG).show();
                } else if (Objects.equals(issuerName, "Netspark")) {
                    Toast.makeText(getApplicationContext(), getString(R.string.not_ssl_by_netspark), Toast.LENGTH_LONG).show();
                }
            }
        }
    }
